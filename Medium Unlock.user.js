...
// @version        1.1
// @description    Automatically detect Medium articles (including subdomains and custom domains) and replace the URL with scribe.rip to unlock Medium Posts.
    ...
    DragButton.prototype = {
        ...
        click: function () {
            ...
            if (window.location.hostname.indexOf("medium.com") < 0) {
                ...
                // use freedium instead of scribe.rip
